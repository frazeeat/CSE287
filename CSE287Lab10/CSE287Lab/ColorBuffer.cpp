...
*/
void ColorBuffer::setColorBufferSize( const int width, const int height) {
...
*/
void ColorBuffer::setPixel(const float x, const float y, const GLubyte rgba[]) {
...
* is the lower left hand corner of the window.
*/
void ColorBuffer::setPixel(const int x, const int y, const color & rgba) {
...
* is the lower left hand corner of the window.
*/
void ColorBuffer::setPixel(const float x, const float y, const color & rgba) {
...
* is the lower left hand corner of the window.
*/
void ColorBuffer::setPixel(const int x, const int y, const GLubyte rgba[]) {
